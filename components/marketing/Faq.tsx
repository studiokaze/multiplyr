...
const QA: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "Most builders go straight from your prompt to code. multipyler does the work you would do before writing code — sharpening the framing, checking who else exists, weighing demand, pressure-testing on your segment — and carries that context into the build, in one place.",
  },
  {
